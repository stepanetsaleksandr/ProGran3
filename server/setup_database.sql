-- ===========================================
-- PROGRAN3 LICENSING DATABASE SETUP
-- ===========================================
...
-- 2. Create indexes for license_keys
...
-- 3. Enable RLS for license_keys
ALTER TABLE license_keys ENABLE ROW LEVEL SECURITY;

-- 4. Create RLS policy for license_keys
CREATE POLICY "Service role full access" ON license_keys
  FOR ALL USING (auth.role() = 'service_role');

-- 5. Update licenses table to use duration_days instead of license_type
...
ALTER TABLE licenses ADD COLUMN IF NOT EXISTS activated_at TIMESTAMP WITH TIME ZONE;
